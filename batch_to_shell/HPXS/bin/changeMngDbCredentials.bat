...
SET MAINCLASS=com.hp.btoe.postinstall.configwizard.fm.fnd.ChangeMngDbCredentialsCommandLine
...
set JAVA_OPTS=%JAVA_OPTS% -Dlog4j.configuration="file:%BTOA_HOME%\conf\changeMngDbCredentials-log4j.xml"
